...
There is also a companion command-line utility to evaluate cron time expressions: <https://github.com/dckrz/supercronic/cronexpr/tree/master/cronexpr> (which of course uses this library).
...
Import the library:
    ...
    import "github.com/dckrz/supercronic/cronexpr"
    import "time"
...
API
---
<http://godoc.org/github.com/dckrz/supercronic/cronexpr>
